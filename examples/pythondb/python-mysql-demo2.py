...
# Instead of hard-coding connection parameters like this:
# con = connect(user='root', password='passw0rd', database='localhost', host='simpledb')

# We define then in a separate file (dbconfig.py) and import them
import dbconfig
